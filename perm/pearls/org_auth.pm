...
sub info($){
    # my $self = shift;
    return "N Organisation - Berechtigungs Bericht",
           "Alle vergebenen und aktiven Berechtigungen fuer eine Organisation";
}
...
sub template ($){
    ...
    #         name      desc                        widget
    return [
            [ 'fid',    'Funktionsinhaber',           'hidcombo(combo=org_combo,ref=org)', '','\d+'  ],
...
SQL
    ...
    $rep->group(  # title
        ...
        -head    => sub {
                        ...
                        my $out  = "Alle Berechtigungen fuer Organisation";
