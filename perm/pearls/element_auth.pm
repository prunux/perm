...
sub info($){
    # my $self = shift;
    return "D Element - Berechtigungen",
           "Alle vergebenen und aktiven Berechtigungen fuer dieses Element";}
...
sub template ($){
    ...
    #         name      desc                        widget
    return [
            [ 'eid',    'Element',                    'hidcombo(combo=element_combo,ref=element)', '','\d+'  ],
