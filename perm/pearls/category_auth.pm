...
sub info($){
    # my $self = shift;
    return "A Kategorie - Berechtigungen",
           "Alle vergebenen und aktiven Berechtigungen fuer diese Kategorie";
}
...
sub template ($){
    ...
    #         name      desc                        widget
    return [
            [ 'cid',    'Kategorie',                  'hidcombo(combo=category_combo,ref=category)', '','\d+'  ],
